...
static void lcd_move_x()
{
	if(encoderPosition != 0)
	{
		...
		encoderPosition = 0;
		plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], manual_feedrate[X_AXIS]/60);
		lcdDrawUpdate = 1;
	}
	if(lcdDrawUpdate)
	{
...
static void lcd_move_y()
{
	if(encoderPosition != 0)
	{
		...
		encoderPosition = 0;
		plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], manual_feedrate[Y_AXIS]/60);
		lcdDrawUpdate = 1;
	}
	if(lcdDrawUpdate)
	{
...
static void lcd_move_z()
{
	if(encoderPosition != 0)
	{
		...
		encoderPosition = 0;
		plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], manual_feedrate[Z_AXIS]/60);
		lcdDrawUpdate = 1;
	}
	if(lcdDrawUpdate)
	{
